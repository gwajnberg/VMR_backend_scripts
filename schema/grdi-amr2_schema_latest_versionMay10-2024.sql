...
CREATE TABLE GENOMIC_TARGET_ENRICHMENT_METHODS(
    id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, 
    GENOMIC_TARGET_ENRICHMENT_METHODS TEXT NOT NULL,
    ONTOLOGY_ID TEXT,
    DESCRIPTION TEXT
);
...
CREATE TABLE BIOINFORMATICS_ANALISYS(
    id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, 
    SEQUENCING_ID integer REFERENCES SEQUENCING(id),
    QUALITY_CONTROL_METHOD_NAME TEXT,
    QUALITY_CONTROL_METHOD_VERSION TEXT,
    QUALITY_CONTROL_DETERMINATION REFERENCES QUALITY_CONTORL_DETERMINATIONS(id),
    QUALITY_CONTROL_ISSUES REFERENCES QUALITY_CONTROL_ISSUES(id),
    QUALITY_CONTROL_DETAILS TEXT,
    RAW_SEQUENCE_DATA_PROCESSING_METHOD TEXT,
    DEHOSTING_METHOD TEXT,
    SEQUENCE_ASSEMBLY_SOFTWARE REFERENCES SEQUENCE_ASSEMBLY_SOFTWARE(id),
    ...
    CONSENSUS_GENOME REFERENCES CONSENSUS_GENOMES(id),
    REFERENCE_GENOME_ACCESSION REFERENCES REFERENCE_GENOME_ACCESSIONS(id),
    DEDUPLICATION_METHOD TEXT,
    BIOINFORMATICS_PROTOCOL TEXT,
    READ_MAPPING_SOFTWARE_NAME REFERENCES READ_MAPPING_SOFTWARE_NAMES(id),
...
SELECT
    "Bioinformatics Analysis"."id" AS "id",
    "Bioinformatics Analysis"."sequencing_id" AS "sequencing_id",
    "Bioinformatics Analysis"."quality_control_method_name" AS "quality_control_method_name",
    "Bioinformatics Analysis"."quality_control_method_version" AS "quality_control_method_version",
    "Quality Control Determinations"."quality_control_determination" AS "quality_control_determination",
    "Quality Control Issues"."quality_control_issue" AS "quality_control_issue",
    "Bioinformatics Analysis"."quality_control_details" AS "quality_control_details",
    "Bioinformatics Analysis"."raw_sequence_data_processing_method" AS "raw_sequence_data_processing_method",
    "Bioinformatics Analysis"."dehosting_method" AS "dehosting_method",
    "Sequence Assembly Software"."sequence_assembly_software" AS "sequence_assembly_software",
    "Bioinformatics Analysis"."sequence_assembly_software_version" AS "sequence_assembly_software_version",
    "Bioinformatics Analysis"."breadth_of_coverage_value" AS "breadth_of_coverage_value",
    "Bioinformatics Analysis"."depth_of_coverage_value" AS "depth_of_coverage_value",
    "Bioinformatics Analysis"."depth_of_coverage_threshold" AS "depth_of_coverage_threshold",
    "Bioinformatics Analysis"."genome_completeness" AS "genome_completeness",
    "Bioinformatics Analysis"."number_of_base_pairs_sequenced" AS "number_of_base_pairs_sequenced",
    "Bioinformatics Analysis"."number_of_totalreads" AS "number_of_totalreads",
    "Bioinformatics Analysis"."number_of_unique_reads" AS "number_of_unique_reads",
    "Bioinformatics Analysis"."minimum_post_trimming_read_length" AS "minimum_post_trimming_read_length",
    ...
    "Read Mapping Software Names"."read_mapping_software_name" AS "read_mapping_software_name",
    "Bioinformatics Analysis"."read_mapping_software_version" AS "read_mapping_software_version"
FROM
...
CREATE VIEW taxonomic_information_view AS
SELECT
    "Taxonomic Information"."id" AS "id",
    "Taxonomic Information"."sequencing_id" AS "sequencing_id",
    "Taxonomic Information"."taxonomic_reference_database_name" AS "taxonomic_reference_database_name",
    "Taxonomic Information"."taxonomic_reference_database_version" AS "taxonomic_reference_database_version",
    "Taxonomic Information"."taxonomic_analysis_report_filename" AS "taxonomic_analysis_report_filename",
    "Taxonomic Information"."read_mapping_criteria" AS "read_mapping_criteria"
FROM
